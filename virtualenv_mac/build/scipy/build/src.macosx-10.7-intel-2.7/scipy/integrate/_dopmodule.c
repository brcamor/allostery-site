...
/*pyobjfrom*/
  if (cb_fcn_in___user__routines_nofargs>capi_i)
    if (PyTuple_SetItem((PyObject *)capi_arglist,capi_i++,pyobj_from_double1(x)))
      goto capi_fail;
  if (cb_fcn_in___user__routines_nofargs>capi_i) {
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,1,y_Dims,NPY_DOUBLE,NULL,(char*)y,0,NPY_CARRAY,NULL); /*XXX: Hmm, what will destroy this array??? */
...
/*pyobjfrom*/
  ...
  if (cb_solout_in___user__routines_nofargs>capi_i) {
    PyArrayObject *tmp_arr = (PyArrayObject *)PyArray_New(&PyArray_Type,1,icomp_Dims,NPY_INT,NULL,(char*)icomp,0,NPY_FARRAY,NULL); /*XXX: Hmm, what will destroy this array??? */
